...
function dydt = pettHertzel(t,y, Z, params)
t_Bmal1 = Z(:,1);
t_RevErb = Z(:,2);
t_Per2 = Z(:,3);
t_Cry1 = Z(:,4);
...
dydt(1,1) = f1 - d_Bmal1*Bmal1;

f2 = ((((b_RevErb*t_Bmal1(1))/ba2)+1)/((t_Bmal1(1)/ba2)+1))^3;
...
dydt(3,1) = f6*f7*f8*f9 - d_Per2*Per2;

f10 = (1/((t_RevErb(2)/ar4)+1))^2;
f11 = ((((b_Cry1*t_Bmal1(1))/ba4)+1)/((t_Bmal1(1)/ba4)+1))^2;
f12 = (1/((t_Per2(3)/cr4)+1))^2;
f13 = ((((f_Cry1*t_Dbp(5))/fa4)+1)/((t_Dbp(5)/fa4)+1));
f14 = (1/((t_Cry1(4)/gr4)+1))^2;
dydt(4,1) = f10*f11*f12*f13*f14 - d_Cry1*Cry1;

f15 = ((((b_Dbp*t_Bmal1(1))/ba5)+1)/((t_Bmal1(1)/ba5)+1))^3;
f16 = (1/((t_Per2(3)/cr5)+1))^3;
f17 = (1/((t_Cry1(4)/gr5)+1))^3;
dydt(5,1) = f15*f16*f17 - d_Dbp*Dbp;
